...
// ctor
TriangleEngine::TriangleEngine (const PropertyService& properties, const OptixConfig& config)
...
void TriangleEngine::createModule(const OptixConfig& config, const String& ptxStr)
{
...
void TriangleEngine::createProgramGroups(const OptixConfig& config)
{
...
void TriangleEngine::linkPipeline(const OptixConfig& config)
{
...
void TriangleEngine::setupShaderBindingTable(const OptixConfig& config, CameraHandle& camera)
{
...
void TriangleEngine::updateCamera(const OptixConfig& config, CameraHandle& camera, RayGenSbtRecord & rg_sbt)
{
...
void TriangleEngine::updateBackgroundColor()
{
	Vector4f bg = properties.renderProps->getVal<Vector4f>(RenderKey::BackgroundColor);
