...
public:
    ...
    /** Creates a random prime number with a given bit-length.
        ...
        keys generated.
    */
    static juce::BigInteger createProbablePrime (int bitLength,
                                           int certainty,
    ...
    */
    static bool isProbablyPrime (const juce::BigInteger& number, int certainty);


private:
    Prime();

    JUCE_DECLARE_NON_COPYABLE (Prime)
};
