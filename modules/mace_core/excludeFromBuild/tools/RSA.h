...
public:
    ...
    */
    explicit RSA (const juce::String& stringRepresentation);

    /** Destructor. */
    ~RSA();

    bool operator== (const RSA& other) const noexcept;
    bool operator!= (const RSA& other) const noexcept;
    ...
    */
    bool applyToValue (juce::BigInteger& value) const;
    ...
    */
    static void createKeyPair (RSA& publicKey,
                               RSA& privateKey,
                               int numBits,
